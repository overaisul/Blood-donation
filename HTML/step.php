  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box">
        <h2>01</h2>
        <h3>Via SMS</h3>
        <p>Give a message to 01629104730.</p>
      </div>
    </div>
    <div class="col-md-4">
      <div class="box">
        <h2>02</h2>
        <h3>Via Email</h3>
        <p>Send a mail to Bloodinfo.gmail</p>
      </div>
    </div>
    <div class="col-md-4">
      <div class="box">
        <h2>03</h2>
        <h3>Via Website</h3>
        <p>Go to contact us. Leave a message.</p>
      </div>
    </div>
</div>
<div class="container">
    <div class="mem"> 
    <h2>How to be a Donor</h2>
  </div>
  <div class="service1">
  <div class="row">
    <div class="col-md-4">
      <div class="box">
        <h2>01</h2>
        <h3>Website</h3>
        <p>Go the Register option in website</p>
      </div>
    </div>
    <div class="col-md-4">
      <div class="box">
    ...
    <div class="col-md-4">
      <div class="box">
        <h2>03</h2>
        <h3>Submit</h3>
        <p>Click the submit button to be a donor.</p>
      </div>
    </div>
  </div>
</div>
